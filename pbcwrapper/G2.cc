...
G2 G2::pow2(const Pairing &e, const G2 &base1, const Zr &exp1,
	const G2 &base2, const Zr &exp2)
{
	G2 gout(e, true);
...
G2 G2::pow3(const Pairing &e, const G2 &base1, const Zr &exp1,
	const G2 &base2, const Zr &exp2, const G2 &base3, const Zr &exp3)
{
	G2 gout(e, true);
...
G2::G2(const Pairing &e, const unsigned char *data, unsigned short len,
...
G2::G2(const Pairing &e, string data, unsigned short len): G(e) {
	if (elementPresent) {
		element_init_G2(g, *(pairing_t*)&e.getPairing());
		int hash_len = 20;
